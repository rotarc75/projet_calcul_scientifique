\label{sec:main}
L'annexe ci-dessous contient le fichier principal du programme. En particulier, nous y avons inclus les fonctions spécifiques aux tests numériques (affichage du maillage, évaluation de $u^h$ en un point de $\Omega$, $\dots$) et à la génération des .txt à partir desquels nous avons pu visualiser nos résultats (questions 30, 32(c) et 32(d)).
\vspace{0.8em}
