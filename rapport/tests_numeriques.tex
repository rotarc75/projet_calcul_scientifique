...
En augmentant le nombre de points, on obtient les 3 courbes suivantes, qui montre l'évolution de l'erreur.

\begin{center}
    \includegraphics[width=1\linewidth]{courbes_erreurs.png}
