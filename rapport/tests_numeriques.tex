\begin{remark*}
    ...
    La fonction de la question 32(b) est incluse dans le code fourni dans l'annexe "les fonctions". Le reste du code lié à cette partie est intégré au main, également en annexe.
...
On remarque que pour $N=4$, l'erreur plonge, ce qui indique que la solution approchée correspond presque exactement à la solution réelle : les noeuds du maillage semblent donc coïnder avec les points de la solution exacte.
