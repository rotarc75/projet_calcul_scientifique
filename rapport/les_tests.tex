...
Cette annexe présente, le fichier tests.cpp, qui regroupe l'ensemble des tests effectués tout au long du projet, dans le but de s'assurer de la correction des fonctions implémentées.

\vspace{0.8em}


\begin{codeblock}[tests.cpp]
