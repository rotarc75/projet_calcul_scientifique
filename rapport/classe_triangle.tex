\label{sec:triangle}
Le code ci-dessous permet de créer la classe Triangle, entièrement définie par le numéro de ses sommets dans le maillage. Elle comprend également un getter qui renvoie le numéro du sommet demandé. Nous avons de plus surchargé l'opérateur = afin de faciliter les tests.
