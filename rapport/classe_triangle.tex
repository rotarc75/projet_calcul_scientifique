Le code ci dessous permet de créer la classe Triangle, entièrement définie par le numéro de ses sommets dans le maillage. Elle comprend également une fonction get qui permet de récupérer le numéro de ses sommets individuellement. Nous avons également ajouté une fonction permettant de vérifier si deux triangles sont égaux.
